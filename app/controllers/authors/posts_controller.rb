module Authors
	class PostsController < AuthorController
	  ...
	  def update
	    ...
	    respond_to do |format|
	      if @post.update(post_params)
	        format.html { redirect_to authors_post_url(@post), notice: 'Post was successfully updated.' }
	  ...
	  private
	    ...
	    def post_params
	      params.require(:post).permit(:title, :body, :description, :banner_image_url, :published, :tag_list)
	    end
	end
